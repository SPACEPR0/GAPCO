...
class EvidencesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create evidence" do
    assert_difference('Evidence.count') do
      post evidences_url, params: { evidence: { description: @evidence.description, title: @evidence.title } }
    end
  ...
  test "should update evidence" do
    patch evidence_url(@evidence), params: { evidence: { description: @evidence.description, title: @evidence.title } }

...
class AlertsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create alert" do
    assert_difference('Alert.count') do
      post alerts_url, params: { alert: { content: @alert.content, expiration: @alert.expiration } }
    end
  ...
  test "should update alert" do
    patch alert_url(@alert), params: { alert: { content: @alert.content, expiration: @alert.expiration } }
